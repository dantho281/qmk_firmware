...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT(
		DV_QUOT, DV_COMM, DV_DOT, DV_P, DV_Y, DV_F, DV_G, DV_C, DV_R, DV_P,
		DV_A, DV_O, DV_E, DV_U, DV_I, DV_D, DV_H, DV_T, DV_N, DV_S,
		DV_SCLN, DV_Q, DV_J, DV_K, DV_X, KC_MPLY, KC_PSCREEN, DV_B, DV_M, DV_W, DV_V, DV_Z,
		KC_LCTRL, KC_LALT, KC_LGUI, RAISE , KC_ENT, KC_SPC, LOWER, KC_RGUI, KC_RALT, KC_RCTRL
		),
